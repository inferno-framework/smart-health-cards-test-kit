RSpec.describe SmartHealthCardsTestKit::SHCHeaderVerification do
  let(:suite_id) { 'smart_health_cards' }

  describe 'health_card_header_test' do
    let(:test) { find_test suite, 'shc_header_verification_test' }
    ...
    it 'passes if a comma-separated list of jws all contain valid headers' do
