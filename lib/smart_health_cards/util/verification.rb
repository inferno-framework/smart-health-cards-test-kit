...
module SmartHealthCards
  ...
  module Verification
    ...
    # @param key_set [SmartHealthCards::KeySet, nil] the KeySet from which keys should be taken or added
    ...
    def verify_using_key_set(verifiable, key_set = nil, resolve_keys: true)
      ...
      key_set ||= SmartHealthCards::KeySet.new
